...
- **[mockingjay](https://github.com/yonatan-levin/mockingjay)** — where ideas start. Research and ML experimentation; the notebooks that decide what's worth promoting into the stack.
